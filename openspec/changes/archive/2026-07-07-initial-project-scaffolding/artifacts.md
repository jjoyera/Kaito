...
- `openspec/changes/initial-project-scaffolding/proposal.md` — created in the
...
- `openspec/changes/initial-project-scaffolding/design.md` — created in the
  ...
  reveal extra scope).
- `openspec/changes/initial-project-scaffolding/tasks.md` — created in the tasks
...
- `openspec/changes/initial-project-scaffolding/apply-progress.md` — created in
